class SDKQuick implements ISDKHandler {
    ...
    private static _instance: SDKQuick;
    constructor() { }

    private logoUrl: string = "http://cdn.ih5games.com/FREEGAME/logo.png";
    private GAME_TITLE: string = '';
    private GAME_DESC: string = '';
    private productCode = "05425578266356246482673853629430";

    // 没有强制限制，仿一个Singleton
    public static getInstance(): SDKQuick {
        if (this._instance == null) {
            this._instance = new SDKQuick();
        }
