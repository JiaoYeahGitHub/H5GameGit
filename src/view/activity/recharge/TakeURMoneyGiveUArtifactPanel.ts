class TakeURMoneyGiveUArtifactPanel extends BaseWindowPanel {
    ...
    protected onSkinName(): void {
        this.skinName = skins.TakeURMoneyGiveUArtifactPanelSkin;
    }
    protected onInit(): void {
        ...
        this.coatard_exp_pro.maximum = 2000;
    ...
    private shenqiTimeCircle() {
        if (this.currentState == 'pay') {
            let time: number = DataManager.getInstance().activityManager.getActivityCD(ACTIVITY_BRANCH_TYPE.MONEYTAKEGODGIFT);
