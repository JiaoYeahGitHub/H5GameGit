class HefuRankPanel extends BaseTabView {
...
//转盘排行榜ITEM
class HefuActRankItem extends BaseListItem {
	...
	protected onUpdate(): void {
		...
		let rankData: HefuActRank = DataManager.getInstance().festivalWuYiManager.zhuanpanRanks[rank - 1];
		if (rank > 3) {
