class ActivityZhongqiuTurntable extends ActivityZhongqiuBase{
	...
	protected onSkinName(): void {
		this.type = ZHUANPAN_TYPE.turntable;
		this.skinName = skins.ActivityZhongqiuTurntable;
	}
	...
	private getRewardIdx(){
		var type = this.zqManager.itemList[0].itemType;
		var id = this.zqManager.itemList[0].itemId;
		var count = this.zqManager.itemList[0].itemCount;
