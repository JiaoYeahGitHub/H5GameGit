class ActivityZhuanpanDan extends ActivityLabaBase {
	...
	protected onSkinName(): void {
		this.skinName = skins.ActivityzhuanpanDan;
	}
	protected onInit(): void {
		...
		// _redPoint.register(this.btnFire, GameDefine.RED_BTN_POS, this.labaManager, 'getActivityPoint');
		// this.points = [_redPoint];
	}
