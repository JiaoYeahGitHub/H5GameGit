class ActivityZhuanpanPoker extends ActivityLabaBase {
	...
	protected onSkinName(): void {
		this.skinName = skins.ActivityzhuanpanPoker;
	}
	...
	protected onDealRocker(){
		let time = 500;
		this.onActionRun(this.imgRockers[0], this.imgRockers[1].x - 210, time);
		this.onActionRun(this.imgRockers[2], this.imgRockers[1].x + 210, time, true);
	}
